...
import { fetchAllProductsAction } from "../../redux/slices/products/productSlice";
import baseURL from "../../utils/baseURL";
import { resetProducts } from "../../redux/slices/globalAction/globalAction";

const HomeProductTrending = () => {
  const dispatch = useDispatch();
  const url = baseURL + "/products";
  useEffect(() => {
    dispatch(fetchAllProductsAction({ url: url }));
  }, [dispatch]);
